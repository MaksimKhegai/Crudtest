...
/**
 * Provides the local service interface for Genre. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author kmv
 * @see GenreLocalServiceUtil
...
public interface GenreLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GenreLocalServiceUtil} to access the genre local service. Add custom service methods to {@link com.liferay.test.portlet.service.impl.GenreLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
