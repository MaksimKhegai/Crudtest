 ...
 * @generated
 */
public abstract class PublisherActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PublisherActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PublisherLocalServiceUtil.getService());
		setClass(Publisher.class);

		setClassLoader(com.liferay.test.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("publisherId");
	}
}