 ...
 * @generated
 */
public abstract class GenreActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public GenreActionableDynamicQuery() throws SystemException {
		setBaseLocalService(GenreLocalServiceUtil.getService());
		setClass(Genre.class);

		setClassLoader(com.liferay.test.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("genreId");
	}
}