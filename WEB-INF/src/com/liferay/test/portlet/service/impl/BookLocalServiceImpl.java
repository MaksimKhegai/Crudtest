 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.liferay.test.portlet.service.BookLocalService} interface.
 *
 * <p>
...
public class BookLocalServiceImpl extends BookLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link com.liferay.test.portlet.service.BookLocalServiceUtil} to access the book local service.
	 */
	...
	public Book addBook(long companyId, long groupId, long userId, long bookId, String name, long author, long genre, 
			long publisher, String date) throws SystemException {
		Book newBook = bookPersistence.create(0);

		try {
			resourceLocalService.addResources(
					companyId, groupId, userId, Book.class.getName(),
				    bookId, false,
				    true, true);
	...
	@Override
	public Book addBook(long userId, long bookId, String name)
			throws SystemException {
		// TODO Auto-generated method stub
		return null;
	}
	
	public boolean deletePermissions(long companyId, long bookId) throws PortalException, SystemException {
		resourceLocalService.deleteResource(companyId, Book.class.getName(), ResourceConstants.SCOPE_INDIVIDUAL, bookId);
		return true;
